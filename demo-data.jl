using SQLite; using DataFrames; using JuMP; using OrderedCollections: OrderedDict
...
Dict("query" => "SELECT REG,ALLYEAR,ALLYEAR2,PRC FROM RTP_VINTYR", "entity" => "RTP_VINTYR"),
...
Dict("query" => "SELECT REG,ALLYEAR,PRC,value FROM NCAP_PASTI", "entity" => "NCAP_PASTI"),
Dict("query" => "SELECT REG,ALLYEAR,PRC,BD,value FROM CAP_BND", "entity" => "CAP_BND"),
Dict("query" => "SELECT REG,ALLYEAR,PRC,LIM,value FROM NCAP_BND", "entity" => "NCAP_BND"),
Dict("query" => "SELECT R,ALLYEAR,T,PRC,value FROM COEF_CPT", "entity" => "COEF_CPT"),
Dict("query" => "SELECT R,ALLYEAR,T,PRC,S,BD,value FROM COEF_AF", "entity" => "COEF_AF"),
Dict("query" => "SELECT REG,ALLYEAR,PRC,CG,C,CG2,TS,value FROM COEF_PTRAN", "entity" => "COEF_PTRAN"),
Dict("query" => "SELECT REG,ALLYEAR,PRC,C,CG,TS,BD,value FROM FLO_SHAR", "entity" => "FLO_SHAR"),
Dict("query" => "SELECT REG,ALLYEAR,PRC,CG,value FROM PRC_ACTFLO", "entity" => "PRC_ACTFLO"),
...
Dict("query" => "SELECT R,ALLYEAR,P,C,S,IE,CUR,value FROM OBJ_IPRIC", "entity" => "OBJ_IPRIC"),
